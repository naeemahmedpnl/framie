...
class SubServiceByServiceIdScreen extends StatefulWidget {
  final String serviceId;
  const SubServiceByServiceIdScreen({super.key, required this.serviceId});

  @override
  State<SubServiceByServiceIdScreen> createState() =>
      _SubServiceByServiceIdScreenState();
}

class _SubServiceByServiceIdScreenState
    extends State<SubServiceByServiceIdScreen> {
